                    ...
                    <div class="card">
                        ...
                        <div class="card-footer p-3">
                            ...
                            <div class="d-flex align-items-center justify-content-between mt-2">
                                <a href="{{$repository->html_url}}" class="btn btn-outline-primary btn-sm mb-0">View Project</a>
                                <div class="avatar-group mt-2">
                                  <a href="{{$repository->owner->html_url}}" class="avatar avatar-xs rounded-circle" data-bs-toggle="tooltip" data-bs-placement="bottom" title="{{$repository->owner->login}}">
